...
static OpenStorageFunction openfunction_ptr __attribute__((section(".data"))) = NULL;
static CloseStorageFunction closefunction_ptr __attribute__((section(".data"))) = NULL;
static const char* plugin_id __attribute__((section(".data"))) = NULL;
...
int WUPS_OpenStorage(void) {
    ...
    int result = openfunction_ptr(plugin_id, &rootItem);
...
static void closeItem(wups_storage_item_t* item) {
    ...
    wups_storage_item_t* items = (wups_storage_item_t*) item->data;
...
int WUPS_CloseStorage(void) {
    ...
    int result = closefunction_ptr(plugin_id, &rootItem);
...
static wups_storage_item_t* addItem(wups_storage_item_t* parent, const char* key, wups_storage_type_t type) {
    wups_storage_item_t* foundItem = NULL;
    for (uint32_t i = 0; i < parent->data_size; i++) {
        wups_storage_item_t* item = &((wups_storage_item_t*)parent->data)[i];
